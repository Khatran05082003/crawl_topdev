...
def fetch_details(id_jobs):
    ...
    for job_id in id_jobs:
        ...
        try:
            ...
            soup_company = BeautifulSoup(requests.get(company_link).text, "html.parser")
...
jobs_df.to_csv('jobs.csv', index=False, encoding='utf-8-sig')
company_df.to_csv('companies.csv', index=False, encoding='utf-8-sig')
